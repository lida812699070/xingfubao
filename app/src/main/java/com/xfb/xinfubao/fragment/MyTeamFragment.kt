...
class MyTeamFragment : BaseRecyclerViewFragment<ItemBalanceModel>() {

    var adapter =
        object : BaseQuickAdapter<ItemBalanceModel, BaseViewHolder>(R.layout.item_my_team, list) {
            override fun convert(helper: BaseViewHolder?, item: ItemBalanceModel?) {
